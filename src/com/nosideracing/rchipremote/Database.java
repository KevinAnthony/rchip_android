...
public class Database extends SQLiteOpenHelper {
	...
	Log.i(Consts.LOG_TAG, "Deleting all row " + id + " from " + TABLE_NAME_SL);
	...
	Log.v(Consts.LOG_TAG, "Got " + C.getCount() + " Rows from table " + TABLE_NAME_SL);
	...
	if (rows < 1) {
	    ...
	    Log.v(Consts.LOG_TAG, "Inserted " + rows + " into table " + TABLE_NAME_SL);
	}
    }
